...
import { Feather, MessageCircle, UserX, Flame, Sword, ArrowLeft } from 'lucide-react';
      ...
      <div className="bg-slate-900 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-lg font-medium text-slate-50">friction</div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800">
            ...
            <div className="p-3">
              <textarea
                ...
                className="w-full bg-transparent text-slate-50 placeholder-slate-500 resize-none focus:outline-none text-sm leading-relaxed"
            ...
            <div className="flex items-center justify-between px-3 py-2 border-t border-slate-800">
              ...
              <div className="flex items-center gap-2 relative" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {showBossModeDropdown && (
                  <div className="absolute top-full left-0 mt-2 bg-slate-800 border border-slate-700 rounded-lg shadow-lg z-50 w-[320px]">
